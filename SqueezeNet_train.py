...
num_ftrs = model_conv.features.size()  
...
# opoosed to before.
optimizer_conv = optim.SGD(model_conv.classifier.parameters(), lr= args.learning_rate, momentum= args.momentum)  
...
if __name__ == "__main__":
    ...
    model_conv.eval()
    torch.save(model_conv, './covid_squeeznet_epoch%d.pt' %args.epochs )
